...
import (
	...
	mg "github.com/atoyr/MagiaRecord/services/Type/app"
	_ "github.com/atoyr/MagiaRecord/services/Type/app/controllers"
...
func main() {
	app := cli.NewApp()
	app.Name = "MagiaRecord Type Service"
	app.Usage = "MagiaRecord Type Service"
	app.Version = version
