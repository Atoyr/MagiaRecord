...
import (
	...
	mg "github.com/atoyr/MagiaRecord/services/Disk/app"
	_ "github.com/atoyr/MagiaRecord/services/Disk/app/controllers"
...
func main() {
	app := cli.NewApp()
	app.Name = "MagiaRecord Disk Service"
	app.Usage = "MagiaRecord Disk Service"
	app.Version = version
